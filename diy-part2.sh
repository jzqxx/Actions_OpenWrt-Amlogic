...
# Modify default IP（FROM 192.168.1.1 CHANGE TO 192.168.123.2）
sed -i 's/192.168.1./192.168.123./g' package/base-files/files/bin/config_generate
sed -i 's/192.168.1./192.168.123./g' package/base-files/luci2/bin/config_generate
sed -i 's/192.168.1./192.168.123./g' package/base-files/Makefile
sed -i 's/192.168.1./192.168.123./g' package/base-files/image-config.in
